...
export function Promotions() {
    ...
    const promotions: Promotion[] = [
        ...
        {
            id: 2,
            title: "Iron Pump Launch",
            description: "Special inaugural pricing for the newly onboarded premium studio.",
            type: "New Launch",
            status: "Scheduled",
            impact: "---",
            expiry: "Starts in 2d"
    ...
    return (
        <div className="p-8 max-w-7xl mx-auto space-y-12 pb-20 font-sans">
            <header className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div>
                    <h2 className="text-4xl font-black text-gray-900 tracking-tighter uppercase italic">Campaign Engine</h2>
                ...
                <div className="flex items-center gap-3 overflow-x-auto pb-2">
                    {['All', 'Flash Sale', 'New Launch', 'Special Discount'].map(type => (
                        <button
                            ...
                            className={`px-6 py-3 rounded-full font-black text-[10px] uppercase tracking-widest transition-all whitespace-nowrap ${activeType === type ? 'bg-black text-white' : 'bg-gray-50 text-gray-400 hover:text-black'}`}
                        >
                            {type}
                        </button>
                    ))}
                        ...
                        <div key={promo.id} className="p-8 bg-gray-50 rounded-[40px] border border-transparent hover:border-black/5 hover:bg-white hover:shadow-2xl transition-all group">
                            <div className="flex justify-between items-start mb-6">
                                ...
                                <div className="flex gap-2">
                                    <button className="p-2 bg-white rounded-lg shadow-sm border border-gray-100 hover:text-red-500 transition-colors">
                            ...
                            <div className="mt-8 flex items-center justify-between pt-8 border-t border-gray-100">
                                <div className="flex items-center gap-6">
                                    ...
                                    <div>
                                        <p className="text-[9px] font-black text-gray-400 uppercase tracking-widest mb-1">Time To Expiry</p>
