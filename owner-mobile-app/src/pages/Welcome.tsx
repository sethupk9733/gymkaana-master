...
export default function Welcome() {
    ...
    return (
        <div className="min-h-screen bg-white flex flex-col items-center justify-between p-8 relative overflow-hidden">
            ...
            <div className="absolute top-[-10%] right-[-10%] w-[60%] h-[60%] bg-blue-50 rounded-full blur-[120px] opacity-60"></div>
            ...
            <div className="flex-1 flex flex-col items-center justify-center w-full max-w-sm space-y-12 relative z-10">
                ...
                <div className="text-center space-y-4">
                    ...
                    <div>
                        ...
                        <p className="text-blue-600 font-semibold tracking-widest text-xs uppercase mt-1">Partner Portal</p>
                    </div>
                </div>
            ...
            <div className="w-full max-w-sm space-y-4 relative z-10 mt-12">
                <button
                    ...
                    className="w-full bg-blue-600 text-white font-bold py-4 rounded-2xl shadow-xl shadow-blue-200 hover:bg-blue-700 hover:shadow-blue-300 active:scale-[0.98] transition-all flex items-center justify-center gap-2 group"
                >
                    Sign In
                ...
                <p className="text-center text-xs text-gray-400 mt-4">
                    Trusted by 500+ gym owners across India
                </p>
            </div>
        </div>
    );
