    ...
    return (
        ...
        >
            <div className="h-56 relative overflow-hidden">
                <ImageCarousel images={displayImages} altPrefix={gym.name} />
            ...
            <div className="p-5">
                ...
                {gym.specializations && gym.specializations.length > 0 && (
                    <div className="flex flex-wrap gap-1 mb-5 px-0.5">
                        {gym.specializations.slice(0, 2).map((spec: string) => (
                            <span key={spec} className="px-2 py-0.5 bg-gray-50 text-[8px] font-black uppercase tracking-widest text-gray-400 rounded-md border border-gray-100">
                                {spec}
                            </span>
                        ))}
                        {gym.specializations.length > 2 && (
                            <span className="px-2 py-0.5 bg-gray-50 text-[8px] font-black uppercase tracking-widest text-gray-400 rounded-md border border-gray-100">
                                +{gym.specializations.length - 2}
                            </span>
                        )}
                    </div>
