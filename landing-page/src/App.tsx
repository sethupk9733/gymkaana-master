...
export default function App() {
    ...
    // Navigate to gym details page in marketplace
    const onGymSelect = (gymId: string) => {
        window.location.href = `${URLS.MARKETPLACE}?screen=details&gym=${gymId}`;
    };
                ...
                <div className="container mx-auto px-6">
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 text-center">
                        {[
                            ...
                            { label: "Total Active Clients", value: liveStats ? liveStats.activeMembers : "1.2k" },
                            { label: "Cities Covered", value: liveStats ? liveStats.citiesCovered : "1" },
            ...
            <section id="gyms" className="py-24 bg-background/60">
                <div className="container mx-auto px-6">
                    <div className="flex flex-col md:flex-row items-end justify-between mb-16 gap-6">
                        ...
                        <a
                            href={`${URLS.MARKETPLACE}?screen=home&action=explore`}
                            className="text-primary font-[1000] text-lg p-0 h-auto uppercase tracking-widest hover:opacity-80 transition-opacity flex items-center gap-2 cursor-pointer"
                        >
                            View All Gyms <ArrowRight className="h-5 w-5" />
                        </a>
                    </div>
